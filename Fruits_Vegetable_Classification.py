...
def processed_img(img_path):
    ...
    if label_cap in vegetables:
        return label_cap, "Vegetables"
    elif label_cap in fruits:
        return label_cap, "Fruit"
    else:
        return label_cap, "Unknown"
    ...
    if img_file is not None:
        ...
        if img_file is not None:
            ...
            if result == "Unknown":
                ...
                st.warning("**Predicted : Unknown**")
                st.info("Can't able to fetch the Calories")
            else:
